...
5. **Анализ (DuckDB / Polars)** — SQL-запросы и агрегации через `benchmark.py`
6. **Визуализация (Matplotlib)** — построение графиков через `visualize.py`
...
python aggregate.py    # Агрегация по странам
```
